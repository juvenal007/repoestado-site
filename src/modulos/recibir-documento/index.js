...
const RecibirDocumento = () => {
   ...
   const onSubmit = (e) => {
      ...
      const url = `estado/store/recibido`;
               ...
               <Col xl="12">
                  <div className="card card-default">
                     <div className="card-header mb-0">
                        <div className="text-tittle-card mt-1"><em className="fas fa-sync"></em>&nbsp;Recibir Documento.</div>
                        <hr></hr>
                     </div>
                              ...
                              <div className='container'>
                                 ...
                                 <FormGroup row className='mb-2 justify-content-center'>
                                    ...
                                    <div className="col-xl-6">
                                       <Button block className='text-bold mt-4' size="xl" onClick={onSubmit} color='warning'>Recibir Documento</Button>
                                    </div>
                                 </FormGroup>
                              </div>
                           </form>
...
export default RecibirDocumento;